      ...
      <div class="hero-body">
        <div class="container has-text-centered">
          ...
          <div class="columns is-mobile">
            <div class="column signUpLeft"></div>
            <div class="column signUpRight">
              <div class="card-content">
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input
                      class="input is-rounded inputCostum"
                      type="text"
                ...
                <div class="field">
                  ...
                  <div class="control has-icons-left has-icons-right">
                    <input
                      class="input is-success is-rounded inputCostum"
                      type="text"
                      placeholder="Text input"
                      value=""
                    />
                ...
                <div class="field">
                  <div class="control">
                    <label class="checkbox labelRegistration">
                      <input type="checkbox" className="checkboxCostum" />I
                      agree to the{" "}
                      <a href="#" style={{ color: "rgb(105, 1, 83)" }}>

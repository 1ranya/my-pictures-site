    ...
    for(let i = 0; i < url.length; i++){
      portraits.push(
        <div className=" columnImagePortrait container">
          <img className="image1  opacityPortrait" src={url[i]} alt="Placeholder image"/>
          <div className="card-content favoriteCard">
            ...
            <div className="columns bottomTab">
              ...
              <div className="column is-one-third">
                <a className={clicked == i ? "icon "+ color : "blue"}  onClick={this.colorChange(i)}>
...
export default connect(mapStateToProps,mapDispatchToProps, authenticate) (CollectionDisplay)
